  ...
  const fetchCandidates = async () => {
    try {
      ...
      const response = await axios.get(
        "http://localhost:5000/api/voting/candidates-by-city"
      );
    ...
    <>
      <div className="bg-gray-200 min-h-screen">
        ...
        <div className="flex flex-row items-center p-6">
          <div className="text-4xl font-bold mb-4 text-gray-900 mx-auto">
            نظام الانتخاب للقائمة المحلية
          </div>
          <img
            src={img3}
            alt="وصف الصورة"
                  ...
                  {cities
                    ...
                    ?.candidates.map((candidate) => (
                      <label
                        ...
                        className="flex items-center justify-between p-2 bg-white rounded-md shadow-sm hover:bg-gray-50 transition-colors duration-150"
                      >
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        ...
                        {selectedCandidates.length === 0 && selectedList
                          ? " لم يتم اختيار أي مرشحين."
                          : ""}
                        {selectedList
                          ? ""
                          : " لم يتم اختيار أي قائمة (الورقة البيضاء)."}
                      </p>
                    </div>
